                ...
                <div class="more__info__data">
                  ...
                  <div id="flex-aside">
                    <aside class="more__info__aside-1">
                      <p class="more__info__aside__p aside-1"><b>Native name :</b> ${nameNative(
                        e
                      )}</p>
                      <p class="more__info__aside__p aside-1"><b>Population :</b> ${
                        e.population
                      }</p>
                      <p class="more__info__aside__p aside-1"><b>Region :</b> ${
                        e.region
                      }</p>
                    </aside> 
                    <aside class = "more__info__aside-2" >
                      <p class="more__info__aside__p aside-2"><b>Sub Region :</b> ${
                        e.subregion
                      }</p>
                      <p class="more__info__aside__p aside-2"><b>Capital :</b> ${
                        e.capital[0]
                      }
                      <p class="more__info__aside__p aside-2"><b>Top Level Domain : </b> ${
                        e.tld[0]
                      }</p> 
                    </aside>                  
                  </div>
